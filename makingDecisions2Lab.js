...
/*
  ...
  between 80 and 89,console log a 'B', between 70 and 79, 'C', between 60 and 69, 'D', and anything below
   60 should console log an 'F'.
*/
...
// Use a for-loop to iterate through 'listOfNumbers',
//checking to see if each number is divisible by 3. If it is, console.log '{number} is divisible by 3.'

//Code Here
for (i = 0; i < listOfNumbers; i++) {
